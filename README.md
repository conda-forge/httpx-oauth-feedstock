...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/httpx-oauth-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15065&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/httpx-oauth-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `httpx-oauth` can be installed with:

```
conda install httpx-oauth
```

It is possible to list all of the versions of `httpx-oauth` available on your platform with:
